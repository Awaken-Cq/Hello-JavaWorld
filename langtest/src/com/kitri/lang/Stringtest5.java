...
public class Stringtest5 {
	public static void main(String[] args) {
		...
		int y = str.indexOf('a', 8);
		System.out.println(str + "에서 8번째부터  a는 " + (y + 1) + "번째 있다.");

		int z = str.indexOf("java");
		System.out.println(str + "에서 java는 " + (z + 1) + "번째 있다.");

		int g = str.lastIndexOf('a');
		System.out.println(str + "에서 끝에서부터  a는 " + (g + 1) + "번째 있다.");
